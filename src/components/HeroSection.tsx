  ...
  return (
    <section className="min-h-[90vh] flex flex-col justify-center px-6 relative scanlines">
      <div className="max-w-6xl mx-auto w-full">
        {/* Tape label */}
        <div className="tape-label inline-block mb-8" style={{ animationDelay: "0.2s" }}>
        ...
        {/* Terminal line */}
        <div className="font-mono text-sm text-muted-foreground mt-8 flex items-center gap-2">
        ...
        {/* Decorative layers */}
        <div className="absolute top-20 right-10 w-32 h-32 border border-border/30 opacity-20 rotate-12 hidden md:block" />
        <div className="absolute top-28 right-16 w-24 h-24 border border-primary/20 opacity-15 rotate-6 hidden md:block" />
